...
-->
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="{{url('/')}}" class="logo">
                            <img style="height: 80px;width:80px" src="assets/images/klassy-logo.png" align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
    ...
    <!-- ***** Header Area End ***** -->
        ...
        <table align="center" bgcolor="#FB5849">
            ...
            <td><a onclick="return confirm ('.Are you sure to remove?')" class="btn btn-danger" href="{{url('remove',$data2->id)}}">Remove</a></td>
