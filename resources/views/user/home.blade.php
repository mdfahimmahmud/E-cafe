                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="{{ url('/') }}" class="logo">
                            <img style="height: 80px;width:80px" src="assets/images/klassy-logo.png"
                                align="E-cafe html template">
                        </a>
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="{{ url('/') }}" class="">Home</a>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>E-cafe is one of the best <a href="https://templatemo.com/tag/restaurant" target="_blank"
                                rel="sponsored">restaurant </a><br><br></p>
                        <div class="row">
                            <div class="col-4">
